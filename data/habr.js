var habr = {
    ...
    init: function() {
        ...
        published.innerText = '' + dd + ' ' + dm + ' ' + dy + ' в 00:00';*/
        published.innerHTML = '20 января 2015 в 00:01';
        ...
        xhr.onload = function() {
            if (xhr.readyState == 4) {
                ...
                for (var i = 0; i < posts.length; i++) {
                    ...
                    var date = post.getElementsByClassName('published')[0].innerHTML;
    ...
    addChild: function(data, time, host, id) {
        ...
        for (var i = 0; i < posts.length; i++) {
            ...
            var date = posts[i].getElementsByClassName('published')[0].innerHTML;
